            ...
            <div className={s.wrapper__content}>
                ...
                <div className={s.wrapper__content_rewiewBlock}>
                    <div className={s.wrapper__content_rewiewBlock__layer}>
                        <article ref={ref1} className={inView1 ? s.wrapper__content_rewiewBlock__layer_BigL : s.message_hidden}>
                        ...
                        <article ref={ref2} className={inView2 ? s.wrapper__content_rewiewBlock__layer_SmallR : s.message_hidden}>
                    ...
                    <div className={s.wrapper__content_rewiewBlock__layer}>
                        <article ref={ref3} className={inView3 ? s.wrapper__content_rewiewBlock__layer_SmallL : s.message_hidden}>
                        ...
                        <article ref={ref4} className={inView4 ? s.wrapper__content_rewiewBlock__layer_BigR : s.message_hidden}>
                    ...
                    <div className={s.wrapper__content_rewiewBlock__layer}>
                        <article ref={ref5} className={inView5 ? s.wrapper__content_rewiewBlock__layer_BigL : s.message_hidden}>
                            <img src={messageImgLBig} className={s.wrapper__content_rewiewBlock__layer_imgBig}/>
                            <div className={s.wrapper__content_rewiewBlock__layer__textBlock}>
                        ...
                        <article ref={ref6} className={inView6 ? s.wrapper__content_rewiewBlock__layer_SmallR : s.message_hidden}>
                            <img src={messageImgRSmall} className={s.wrapper__content_rewiewBlock__layer_imgSmall}/>
                            <div className={s.wrapper__content_rewiewBlock__layer__textBlock}>
